...
def load_dataset():
    ...
    url = "https://raw.githubusercontent.com/santosh04github/Datapipeline/refs/heads/main/Encoded_Customer_support_data.csv"
    column_names = ['CSAT Score', 'Response_Duration', 'Tenure_Bucket_Encoded', 'Agent_Shift_Encoded', 'Product_category_Encoded', 'Sub-category_Encoded', 'channel_name_Encoded', 'Customer_City_Encoded', 'Agent_name_Encoded','Supervisor_Encoded','Manager_Encoded']
...
if __name__ == "__main__":
    Encoded_Customer_support_data.serve(name="Encoded_Customer_support_data",
                      tags=["first workflow"],
                      parameters={},
